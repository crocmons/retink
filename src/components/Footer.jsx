...
const Footer = () => {
  return (
    <div className='bg-gray-300 justify-center text-lg font-bold mx-auto '>
        <img src={Logo} alt='logo' className='w-20 h-20 object-contain text-xl cursor-pointer m-3'/>
       <div className='flex md:flex-row flex-col justify-evenly gap-2 p-2 mb-5'>
           <h3>
           ...
           <p className='font-normal gap-4'>
           Connect with Us
           
           <div className="flex mt-4 space-x-6 sm:justify-center py-3 sm:mt-0">
              <a href="#" className="text-blue-700 hover:text-blue-900 dark:hover:text-white">
              ...
              <a href="#" className="text-pink-600 hover:text-pink-900 dark:hover:text-white">
       ...
       <div className='bg-black text-white font-bold text-sm flex justify-between p-5'>
          <p>
          Copyright &copy; {new Date().getFullYear()} Retink
          </p>
